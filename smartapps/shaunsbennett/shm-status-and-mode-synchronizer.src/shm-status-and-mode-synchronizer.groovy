/**
 *  SHM Status and Mode Synchronizer
 *
 ...
 */
definition(
    name: "SHM Status and Mode Synchronizer",
    namespace: "shaunsbennett",
    author: "Shaun S Bennett",
    description: "Set Smart Home Monitor (SHM) status and synchronize with location current mode",
    category: "My Apps",
...
preferences {
      section("Select your button devices") {
